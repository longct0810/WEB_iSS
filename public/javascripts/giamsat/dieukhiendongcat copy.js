...
function renderTrangThai(result) {
    if (result && result[0] === "OK") {
        ...
        if (trangthai == "1") {
            ...
            document.getElementById("thongbao_ketqua").innerHTML = "DCU đang bận";
            document.getElementById("thongbao_cat").innerHTML = "Không xác định";
        }
...
function renderTrangThai_kq(result) {
    if (result && result[0] === "OK") {
        document.getElementById("thongbao_cat").innerHTML = "";
