...
function save_apdung_idm(v_apdung, v_mataikhoanthuchien, v_danhmucid) {
    return oracledb.getConnection()
        .then(function (conn) {
            return conn.execute(`BEGIN PKG_CAUHINH_CANHBAO_SCADA.P_APDUNG_CONGTHUC_IDM(:apdung,:danhmucid,:mataikhoan,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
                apdung: {
...
async function find(context) {
    ...
    var data = save_apdung_idm(v_apdung, v_mataikhoanthuchien, v_danhmucid);
    return data;
