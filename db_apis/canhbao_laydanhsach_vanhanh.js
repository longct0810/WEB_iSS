...
function getDanhSachCanhBaoVanHanh(v_danhmucid) {
    return oracledb.getConnection()
        .then(function (conn) {
            return conn.execute(`BEGIN PKG_CAUHINH_CANHBAO_SCADA.P_LAY_DS_CANHBAO_VANHANH(:danhmucid,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
                danhmucid: {
...
async function find(context) {
    ...
    var data = getDanhSachCanhBaoVanHanh(danhmucid);
    return data;
