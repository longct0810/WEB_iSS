...
function dsthietbi_iec_104(userid) {
  return oracledb.getConnection()
      .then(function (conn) {
          return conn.execute(`BEGIN PKG_IEC_104.DANHSACH_THIETBI_IEC_104(:u,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
            u: {
...
async function find(context) {
  ...
  if (context.userid) {
    ...
    var data = dsthietbi_iec_104(userid);
    return data;
