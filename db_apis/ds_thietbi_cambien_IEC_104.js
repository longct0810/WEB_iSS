...
function dsthietbi_iec_104(v_idthietbi) {
  return oracledb.getConnection()
      .then(function (conn) {
          return conn.execute(`BEGIN PKG_IEC_104.DANHSACH_CAMBIEN_IEC_104(:u,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
            u: {
...
async function find(context) {
  ...
  if (context.idthietbi) {
    ...
    var data = dsthietbi_iec_104(idthietbi);
    return data;
