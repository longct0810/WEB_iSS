...
function getbaocaoloduongday(danhmucid, tungay, denngay, gio) {
    return oracledb.getConnection()
        .then(function (conn) {
            return conn.execute(`BEGIN PKG_BAOCAOLODUONGDAY.P_GET_BAOCAO_LODUONGDAY(:danhmucid,:tungay,:denngay,:gio,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
                danhmucid: {
...
async function find(context) {
    ...
    if (context.danhmucid) {
        ...
        gio = context.gio;
        var data = getbaocaoloduongday(danhmucid, tungay, denngay, gio);
