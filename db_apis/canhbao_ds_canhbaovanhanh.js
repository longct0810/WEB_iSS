...
function canhbaovanhanh(danhmucid, type, meterid) {
    return oracledb.getConnection()
        .then(function (conn) {
            return conn.execute(`BEGIN PKG_SUKIEN_CONGTO.P_CANHBAO_VANHANH(:danhmucid,:type,:meterid,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
                danhmucid: {
...
async function find(context) {
    ...
    var data = canhbaovanhanh(danhmucid, type, meterid);
    return data;
