...
function scada_tsvh(id_thietbi, tungay, denngay) {
    return oracledb.getConnection()
        .then(function (conn) {
            return conn.execute(`BEGIN PKG_SCADA.P_GET_THONGSOVANHANH(:id_thietbi,:tungay,:denngay,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
                id_thietbi: {
...
async function find(context) {
    ...
    if (context.id_thietbi) {
        ...
        var data = scada_tsvh(id_thietbi, tungay, denngay);
        return data;
