...
function ds_ql_danhmuc_user(danhmucid, danhmucid_lo) {
    return oracledb.getConnection()
        .then(function (conn) {
            return conn.execute(`BEGIN PKG_DANHMUC.P_DS_QL_DANHMUCID_USER(:danhmucid,:danhmucid_lo,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
                danhmucid: {
...
async function find(context) {
    ...
    var danhmucid_lo = oracledb.STRING;
    danhmucid = context.danhmucid;
    danhmucid_lo = context.danhmucid_lo;
    var data = ds_ql_danhmuc_user(danhmucid, danhmucid_lo);
