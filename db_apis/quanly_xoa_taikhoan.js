...
function XoaTaiKhoan(v_mataikhoan, v_taikhoanthuchien) {
    return oracledb.getConnection()
        .then(function (conn) {
            return conn.execute(`BEGIN PKG_TAIKHOAN.P_XOA_TAIKHOAN(:mataikhoan,:taikhoanthuchien,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
                mataikhoan: {
...
async function find(context) {
    ...
    var v_taikhoanthuchien = oracledb.NUMBER;
    if (context.mataikhoan) {
        v_mataikhoan = context.mataikhoan;
        v_taikhoanthuchien = context.taikhoanthuchien;
        var data = XoaTaiKhoan(v_mataikhoan, v_taikhoanthuchien);
        return data;
