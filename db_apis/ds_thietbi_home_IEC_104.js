...
function dsthietbi_iec_104(id_thietbi) {
  return oracledb.getConnection()
      .then(function (conn) {
          return conn.execute(`BEGIN PKG_IEC_104.DANHSACH_THIETBI_HOME_IEC_104(:u,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
            u: {
...
async function find(context) {
  ...
  if (context.id_thietbi) {
    ...
    var data = dsthietbi_iec_104(id_thietbi);
    console.log("data");
    console.log(data);
    return data;
