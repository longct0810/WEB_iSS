...
function khaibaovttb_getthongtin_nhacungcap() {
    return oracledb.getConnection()
        .then(function (conn) {
            return conn.execute(`BEGIN PKG_KHAIBAO_VTTB.P_GET_THONGTIN_NHACUNGCAP(:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
...
async function find(context) {
    ...
    var data = khaibaovttb_getthongtin_nhacungcap();
    return data;
