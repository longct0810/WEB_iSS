...
function getbaocaohoatdong(idthietbi, loaicambien, tungay, denngay) {
    return oracledb.getConnection()
        .then(function (conn) {
            return conn.execute(`BEGIN PKG_BAOCAO_HOATDONG.P_BAOCAO_HOATDONG(:idthietbi,:loaicambien,:tungay,:denngay,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
                idthietbi: {
