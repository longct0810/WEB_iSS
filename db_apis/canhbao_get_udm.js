...
function laydscongthuc_udm(v_danhmucid) {
    return oracledb.getConnection()
        .then(function (conn) {
            return conn.execute(`BEGIN PKG_CAUHINH_CANHBAO_SCADA.P_LAYDS_CONGTHUC_UDM(:danhmucid,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
                danhmucid: {
...
async function find(context) {
    ...
    var data = laydscongthuc_udm(v_danhmucid);
    return data;
