...
function getthietbi(v_id) {
  return oracledb.getConnection()
    .then(function (conn) {
      return conn.execute(`BEGIN PKG_QUANLY_THIETBI.P_GET_THIETBI_BYID(:id,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
        id: {
