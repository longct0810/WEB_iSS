...
function laycanhbaoami(danhmucid, meterid, tungay, denngay, loaicanhbao) {
    return oracledb.getConnection()
        .then(function (conn) {
            return conn.execute(`BEGIN PKG_THONGTIN_CANHBAO.P_GET_CANHBAO_AMI_TUCTHOI_CHITIET(:danhmucid, :meterid, :tungay, :denngay,:loaicanhbao,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
                danhmucid: {
