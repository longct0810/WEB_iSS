...
function getDatakhaibaotb(v_idthietbi,v_idcambien) {
  return oracledb.getConnection()
    .then(function (conn) {
      return conn.execute(`BEGIN PKG_IEC_104.XOA_CAMBIEN_IEC_104(:idthietbi,:idcambien,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
        idthietbi: {
...
async function find(context) {
  ...
  if (context.idcambien) {
    ...
    var data = getDatakhaibaotb(idthietbi,idcambien);
    return data;
