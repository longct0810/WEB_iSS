...
function save_udm(tu, udm) {
    return oracledb.getConnection()
        .then(function (conn) {
            return conn.execute(`BEGIN PKG_CAUHINH_CANHBAO_SCADA.P_LUU_CONGTHUC_UDM(:tu,:udm,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
                tu: {
...
async function find(context) {
    var tu = oracledb.STRING;
    var udm = oracledb.STRING;
    tu = context.v_tu;
    udm = context.v_udm;
    var data = save_udm(tu, udm);
    return data;
