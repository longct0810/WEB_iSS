...
function getbaocaohoatdong(tungay, denngay) {
    return oracledb.getConnection()
        .then(function (conn) {
            return conn.execute(`BEGIN PKG_TAIKHOAN.P_THONGKE_DANGNHAP(:tungay,:denngay,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
...
async function find(context) {
    ...
    if (context.tungay) {
        ...
        var data = getbaocaohoatdong(tungay, denngay);
