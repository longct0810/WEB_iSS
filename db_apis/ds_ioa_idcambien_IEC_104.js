...
function dsthietbi_iec_104(v_idcambien) {
  return oracledb.getConnection()
      .then(function (conn) {
          return conn.execute(`BEGIN PKG_IEC_104.DANHSACH_IOA_IDCAMBIEN_IEC_104(:u,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
            u: {
...
async function find(context) {
  ...
  if (context.idcambien) {
    ...
    var data = dsthietbi_iec_104(idcambien);
    return data;
    
  }else{
    return "Không tìm thấy cảm biến"
  }  
