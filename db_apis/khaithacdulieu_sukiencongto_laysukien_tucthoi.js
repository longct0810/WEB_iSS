...
function sukiencongto(danhmucid, meterid) {
    return oracledb.getConnection()
        .then(function (conn) {
            return conn.execute(`BEGIN PKG_SUKIEN_CONGTO.P_LAYCANHBAOTUCTHOI(:danhmucid,:meterid,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
                danhmucid: {
...
async function find(context) {
    ...
    var data = sukiencongto(danhmucid, meterid);
    return data;
