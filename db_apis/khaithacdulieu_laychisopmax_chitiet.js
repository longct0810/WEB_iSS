...
function chisocongtopmaxchitiet(meterid, socongto, tungay, denngay, sotrang, sodong, mataikhoan, loaichiso) {
    return oracledb.getConnection()
        .then(function (conn) {
            return conn.execute(`BEGIN PKG_DULIEUPMAX.P_LAY_CHISOCTO_PMAX_KH(:meterid,:socongto,:tungay,:denngay,:sotrang,:sodong ,:mataikhoan,:loaichiso,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
                meterid: {
...
async function find(context) {
    ...
    var data = chisocongtopmaxchitiet(meterid, socongto, tungay, denngay, sotrang, sodong, mataikhoan, loaichiso);
    return data;
