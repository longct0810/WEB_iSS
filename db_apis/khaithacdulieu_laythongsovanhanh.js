...
function thongsovanhanh(danhmucid, locdulieu, ngay, gio, loaipha, sotrang, sodong, mataikhoan) {
    return oracledb.getConnection()
        .then(function (conn) {
            return conn.execute(`BEGIN PKG_THONGSOVANHANH.P_LAYDS_TSVH(:danhmucid,:locdulieu,:ngay,:gio,:loaipha,:sotrang,:sodong,:mataikhoan,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
                danhmucid: {
...
async function find(context) {
    ...
    var data = thongsovanhanh(danhmucid, locdulieu, ngay, gio, loaipha, sotrang, sodong, mataikhoan);
    return data;
