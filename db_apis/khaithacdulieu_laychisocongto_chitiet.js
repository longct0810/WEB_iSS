...
function chisocongtochitiet(meterid, loaihienthi, socongto, tungay, denngay, sotrang, sodong, mataikhoan, loaichiso) {
    return oracledb.getConnection()
        .then(function (conn) {
            return conn.execute(`BEGIN PKG_THONGSOVANHANH.P_LAY_CHISOCTO_KH(:meterid,:loaihienthi,:socongto,:tungay,:denngay,:sotrang,:sodong ,:mataikhoan,:loaichiso,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
                meterid: {
...
async function find(context) {
    ...
    var data = chisocongtochitiet(meterid, loaihienthi, socongto, tungay, denngay, sotrang, sodong, mataikhoan, loaichiso);
    return data;
