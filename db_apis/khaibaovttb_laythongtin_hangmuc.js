...
function khaibaovttb_getthongtin_hangmuc(maduan) {
    return oracledb.getConnection()
        .then(function (conn) {
            return conn.execute(`BEGIN PKG_KHAIBAO_VTTB.P_GET_THONGTIND_HANGMUC(:maduan,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
                maduan: {
...
async function find(context) {
    var ma_duan = oracledb.STRING;
    ma_duan = context.ma_duan;
    var data = khaibaovttb_getthongtin_hangmuc(ma_duan);
    return data;
