...
function laycanhbaoami(danhmucid, meterid, tungay, denngay) {
    return oracledb.getConnection()
        .then(function (conn) {
            return conn.execute(`BEGIN PKG_THONGTIN_CANHBAO.P_GET_CANHBAO_AMI(:danhmucid, :meterid, :tungay, :denngay,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
                danhmucid: {
...
async function find(context) {
    ...
    var data = laycanhbaoami(danhmucid, meterid, tungay, denngay);
    return data;
