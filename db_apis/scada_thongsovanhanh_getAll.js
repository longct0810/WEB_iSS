...
function dsthietbi_iec_104(id_thietbi, tungay, gio) {
    return oracledb.getConnection()
        .then(function (conn) {
            return conn.execute(`BEGIN PKG_IEC_104.DANHSACH_THIETBI_HOME_IEC_104(:u,:tungay,:gio,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
                u: {
...
async function find(context) {
    ...
    if (context.id_thietbi) {
        ...
        gio = context.gio;
        var data = dsthietbi_iec_104(id_thietbi, tungay, gio);
        return data;
