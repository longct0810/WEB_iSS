...
function laydscongthuc_idm(v_danhmucid) {
    return oracledb.getConnection()
        .then(function (conn) {
            return conn.execute(`BEGIN PKG_CAUHINH_CANHBAO_SCADA.P_LAYDS_CONGTHUC_IDM(:danhmucid,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
                danhmucid: {
...
async function find(context) {
    var v_danhmucid = context.v_danhmucid;
    var data = laydscongthuc_idm(v_danhmucid);
    return data;
