...
function thongsovanhanhphutai(meterid, socongto, tungay, denngay, sotrang, sodong, mataikhoan) {
    return oracledb.getConnection()
        .then(function (conn) {
            return conn.execute(`BEGIN PKG_THONGSOVANHANH.P_LAY_TSPT_KH(:meterid,:socongto,:tungay,:denngay,:sotrang,:sodong ,:mataikhoan,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
                meterid: {
...
async function find(context) {
    ...
    var data = thongsovanhanhphutai(meterid, socongto, tungay, denngay, sotrang, sodong, mataikhoan);
    return data;
