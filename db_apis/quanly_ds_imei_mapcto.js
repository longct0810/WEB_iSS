...
function ds_ql_danhmuc_user(danhmucid) {
    return oracledb.getConnection()
        .then(function (conn) {
            return conn.execute(`BEGIN PKG_QUANLY_DIEMDO.P_LAY_TT_IMEI_MAP_CTO(:danhmucid,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
                danhmucid: {
...
async function find(context) {
    ...
    var data = ds_ql_danhmuc_user(danhmucid);
