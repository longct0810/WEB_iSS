...
function getDatakhaibaotb(v_idthietbi, v_idcambien, v_ten, v_diachi,v_type,v_scale,v_ghichu,v_idioa) {
  return oracledb.getConnection()
    .then(function (conn) {
      return conn.execute(`BEGIN PKG_IEC_104.SUA_IOA_IEC_104(:idthietbi,:idcambien,:ten,:diachi,:type,:scale,:ghichu,:id_ioa,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
        idthietbi: {
...
async function find(context) {
  ...
  if (context.idioa) {
    ...
    idioa=context.idioa;
    var data = getDatakhaibaotb(idthietbi, idcambien, ten,diachi,type,scale,ghichu,idioa);
    return data;

  } else {
    return "không tìm thấy ioa"
  }
