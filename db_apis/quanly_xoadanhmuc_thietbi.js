...
function XoaDanhMucthietbi(v_id) {
  return oracledb.getConnection()
    .then(function (conn) {
      return conn.execute(`BEGIN PKG_DANHMUC.P_XOA_DANHMUC_THIETBI(:id,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
        id: {
...
async function find(context) {
  ...
  if (context.idthietbi) {
    ...
    var data = XoaDanhMucthietbi(idthietbi);
    return data;
