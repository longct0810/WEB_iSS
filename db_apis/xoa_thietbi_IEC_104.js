...
function getDatakhaibaotb(v_idthietbi) {
  return oracledb.getConnection()
    .then(function (conn) {
      return conn.execute(`BEGIN PKG_IEC_104.XOA_THIETBI_IEC_104(:idthietbi,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE       
        idthietbi:{
...
async function find(context) {
  ...
  if (context.idthietbi) {
    ...
    var data = getDatakhaibaotb(idthietbi);
    return data;
