...
function khaibaovttb_getthongtin_hangmuc(mahangmuc) {
    return oracledb.getConnection()
        .then(function (conn) {
            return conn.execute(`BEGIN PKG_KHAIBAO_VTTB.P_GET_THONGTIND_HANGMUC_CHITIET(:mahangmuc,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
                mahangmuc: {
...
async function find(context) {
    ...
    var data = khaibaovttb_getthongtin_hangmuc(mahangmuc);
    return data;
