...
function getDatakhaibaotb(v_idioa) {
  return oracledb.getConnection()
    .then(function (conn) {
      return conn.execute(`BEGIN PKG_IEC_104.XOA_IOA_IEC_104(:id_ioa,:CV_1); END;`, { // EXECUTE ORACLE PROCEDURE
          id_ioa: {
...
async function find(context) {
  ...
  if (context.idioa) {
      idioa=context.idioa;
    var data = getDatakhaibaotb(idioa);
    return data;
