const employees = require('../db_apis/sua_cambien_IEC_104.js');
...
function getEmployeeFromRec(req) {
  const employee = {
    ...
    tencambien: req.body.v_tencambien,
    giaothuc: req.body.v_giaothuc,
    type: req.body.v_type,
    idcambien:req.body.v_idcambien
  };
  console.log("NHẬN:zzzzz "+ employee);
  return employee;
}
